...
rows, cols = img.shape
# Оператор Sobel є оператором дискретного диференціювання. Він обчислює наближення градієнта функції інтенсивності зображення
# oператор Собеля поєднує згладжування за Гауссом і диференціювання
